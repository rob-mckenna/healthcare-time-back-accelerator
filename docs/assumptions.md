...
| ASM-008 | The target Copilot Studio tenant can source and shape directory role information into the repository-validated identity handoff envelope | Tank | Repository controls are verified and BLOCKER-002 is resolved locally; connected-tenant identity/role validation remains NOT RUN under RISK-020 | Low, unverified in connected tenant |
