...
`docs/evidence/2026-08-13-foundry-live-evaluation.md`. BLOCKER-001,
BLOCKER-002, and BLOCKER-004 remain open and unchanged; BLOCKER-002 is not
claimed resolved and no user identity propagation is claimed.
